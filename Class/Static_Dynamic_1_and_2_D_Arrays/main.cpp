 ...
 * Created on September 5th, 2018, 1:20 PM
...
void prnt1D(int *a,int n,int perLine){
    cout<<endl;
    for(int i=0;i<n;i++){
        cout<<a[i]<<" ";
...
void prnt2D(int **a,int row,int COL){
    cout<<endl;
    for(int i=0;i<row;i++){
        for(int j=0;j<COL;j++){
            cout<<a[i][j]<<" ";
